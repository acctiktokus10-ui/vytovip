# 🤖 VytoVIP Bot — Hệ thống cập nhật dữ liệu từ xa
...
bot_data_loader.py        ← Đặt cùng thư mục với bot_vytovip.py
```
...
Sao chép `bot_data_loader.py` vào cùng thư mục với `bot_vytovip.py`.
...
```python
VERCEL_BASE_URL = "https://vytovip.vercel.app"
```

### 2.3 Sửa bot_vytovip.py
...
1. Mở `https://vytovip.vercel.app` trên điện thoại
